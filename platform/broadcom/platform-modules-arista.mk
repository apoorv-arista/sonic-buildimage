...
ARISTA_PLATFORM_MODULE = sonic-platform-arista_$(ARISTA_PLATFORM_MODULE_VERSION)_$(CONFIGURED_ARCH).deb
...
ARISTA_PLATFORM_MODULE_DRIVERS = drivers-sonic-platform-arista_$(ARISTA_PLATFORM_MODULE_VERSION)_$(CONFIGURED_ARCH).deb
$(eval $(call add_extra_package,$(ARISTA_PLATFORM_MODULE),$(ARISTA_PLATFORM_MODULE_DRIVERS)))

ARISTA_PLATFORM_MODULE_LIBS = sonic-platform-arista-libs_$(ARISTA_PLATFORM_MODULE_VERSION)_$(CONFIGURED_ARCH).deb
...
ARISTA_FWUTIL = arista-fwutil_$(ARISTA_FWUTIL_VERSION)_$(CONFIGURED_ARCH).deb
